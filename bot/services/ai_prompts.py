...
def build_market_briefing_prompt(market_json: Mapping[str, Any], lang: str = "en") -> str:
    ...
    return (
        ...
        "6. MARKET MEMORY: one sentence comparing the current read with prior snapshots.\n"
        "7. MARKET REGIME: one sentence naming the current behavior type and why.\n"
        "8. STRENGTH OF READ: one sentence using weak, moderate, or strong.\n"
        "9. WHAT TO CHECK: two to four bullets about rules, volume, timeframe, and related markets.\n"
        "10. RELATED THEMES: include only if a cross-market connection exists.\n"
        "11. RESOLUTION RULES: one or two plain-language sentences.\n\n"
